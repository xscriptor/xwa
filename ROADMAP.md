...
- [/] init dev branch (#72)
- [ ] Improve the Scan tab. (#76)
- [ ] Improve the Overview tab. (#77)
- [ ] Improve the Performance tab. (#78)
- [ ] Improve the Security tab. (#79)
- [ ] Improve the Network tab. (#80)
- [ ] Improve the Sitemaps tab. (#81)
- [ ] Improve the Stack tab. (#82)
- [ ] Improve the Reports tab. (#83)
- [ ] Improve the SEO tab. (#84)
- [ ] Improve the Accessibility tab. (#85)
- [ ] Improve the Structure tab. (#86)
- [ ] Improve the Content tab. (#87)
- [ ] Improve the Links tab. (#88)
- [ ] Improve the Compliance tab. (#89)
- [ ] Improve the Social tab. (#90)
